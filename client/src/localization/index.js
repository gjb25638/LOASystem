...
export default {
  en: {
    Report: Report.en,
    List: List.en,
    EmployeeAction: EmployeeAction.en,
    Login: Login.en,
    Detail: Detail.en,
    ...
    EmployeeAccountSettings: EmployeeAccountSettings.en,
    LeaveTypeEditorDialog: LeaveTypeEditorDialog.en,
    LeaveForm: LeaveForm.en,
  ...
  zh: {
    Report: Report.zh,
    List: List.zh,
    EmployeeAction: EmployeeAction.zh,
    Login: Login.zh,
    Detail: Detail.zh,
    ...
    EmployeeAccountSettings: EmployeeAccountSettings.zh,
    LeaveTypeEditorDialog: LeaveTypeEditorDialog.zh,
    LeaveForm: LeaveForm.zh,
