              ...
              <td class="min-width-380">
                ...
                >
                  <v-flex xs6 slot="item" slot-scope="subprops">
                    <v-card>
                      <v-card-title>
                        <h4>{{ subprops.item.day + 1 }}{{loalocale.self.day}}</h4>
                      </v-card-title>
                      <v-divider></v-divider>
                      <v-list dense>
                        <v-list-tile
                        ...
                        >
                          <v-list-tile-content>{{generateSummary({ leaveType: record.key, days: record.totals.days > 0 ? 1 : 0, hours: record.totals.hours })}}</v-list-tile-content>
                        </v-list-tile>
                      </v-list>
                    </v-card>
                  </v-flex>
...
export default {
  ...
  created() {
    [
      ...
      { text: this.loalocale.self.dateGroupStat, sortable: false },
