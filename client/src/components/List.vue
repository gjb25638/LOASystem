  ...
  <v-app id="inspire">
                ...
                <v-tooltip bottom>
                  ...
                  >
                    ...
                    <v-card>
                      ...
                      <v-card-text>
                        <v-text-field
                          :label="localeConf.list.input.report"
                          v-model="yearOfReport"
                        ></v-text-field>
                      </v-card-text>
                      <v-card-actions>
                        <v-spacer></v-spacer>
              ...
              >
                ...
                >
                  <td>
                    <v-badge
                      left
                      v-if="props.item.unSigningRecords.length > 0"
                    >
                  ...
                  <td style="min-width:120px">
                    ...
                    <span v-if="fullControl && !props.item.enabled"> |
                      <v-dialog
                        v-model="props.item.confirmToDeleteEmployeeDialog"
                        max-width="290"
                      >
                        <a
                          slot="activator"
                    ...
                    >
                      ...
                      <v-list-tile-action>
                        <v-tooltip bottom>
                          ...
                          ></v-rating>
                          <div
                            v-for="signing in record.signings"
                            :key="signing._id"
                          >
                            <div>
    ...
    >
      <div>
        ...
        <div
          v-for="snackbarText in snackbarTexts"
          :key="snackbarText.index"
        >
