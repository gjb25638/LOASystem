...
mongoose.connect(`mongodb://${DATABASE_URL}/employee`, { useNewUrlParser: true })
...
app.get('/employees/compensatory/:loginuser/:token', employees.compensatory.get)
...
app.get('/monthly/report/:year/:month/:loginuser/:token', report.monthly.groupby.get)
app.get('/monthly/sdehsra/:year/:month/:loginuser/:token', report.monthly.sdehsra.get)
app.get('/annual/report/:year/:loginuser/:token', report.annual.groupby.get)
app.get('/annual/export/report/:year/:loginuser/:token', report.export.annual.get)
